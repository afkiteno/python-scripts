...
def run():
    ...
    my_topics = [
        ...
        # Done "Extended Transition Function", "The Language of NFA", "Equivalence of NFA and DFA",
        # Done "Applications of DFA", "Applications of NFA", "Finite Automata with Epsilon Transition",
        # Done "Uses of Epsilon-Transitions", "Epsilon Closures", "Union, Intersection & Complement",
        ...
        # Done "Finding Patterns in Text, Algebric Laws and Derivatives", "Properties-Non Regular Languages",
        # Done "Pumping Lemma for Regular Language", "Applications of Pumping Lemma",
        # Done "Closure Properties under Boolean Operations",
        # Done "Context Free Grammar-Derivations and Definitions", "The Language of a Grammar, Inferences and Ambiguity", "Sentential Forms", "Construction and Yield of a Parse Tree", "Inferences to Trees and Trees to Derivations", "Ambiguous Grammar",
        # Done "PDA-Acceptance by Final State", "PDA-Acceptance by Empty Stack", "From Grammars to Push Down Automata", "From PDA to Grammars", "Deterministic PDA", "Regular Languages and D-PDA", "DPDA and Context Free Languages",
        # Done "DPDA and Ambiguous Grammars", 
        ...
        # Done "CFL- Closure Properties", "CFL- Other Normal Forms", "Intersection with Regular Languages",
        ...
        # Done "Programming Techniques-Storage and Subroutines", "Multitape Turing Machines",
    ]
